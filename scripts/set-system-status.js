...
async function setSystemStatus(status = "online") {
  try {
    ...
    if (!databaseURL || databaseURL.trim() === "") {
      ...
      console.log("NEXT_PUBLIC_FIREBASE_DATABASE_URL=https://your-project.firebaseio.com");
      process.exit(1);
    }
    ...
    await new Promise((resolve, reject) => {
      ...
      https.get(readUrl.toString(), (res) => {
        let body = "";
    ...
    console.log('   { "rules": { "system": { ".read": true, ".write": true } } }');
    process.exit(1);
  }
}
