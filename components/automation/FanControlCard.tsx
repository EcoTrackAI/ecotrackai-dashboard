    ...
    <div className="bg-white rounded-lg border border-gray-200 p-5 hover:shadow-md transition-shadow">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          className={`relative inline-flex h-7 w-12 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed ${appliance.status === "on" ? "bg-blue-500" : "bg-gray-300"}`}
          title={
            !appliance.isOnline
              ? "Device is offline"
              : appliance.controlMode === "auto"
        ...
        <div className="border-t border-gray-100 pt-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <input
              ...
              disabled={appliance.controlMode === "auto" || !appliance.isOnline}
